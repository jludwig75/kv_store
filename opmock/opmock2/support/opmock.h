...
/*
 * CLang converts bool to _Bool. This results in all of our generated mocks
 * using _Bool instead of bool, which Visual Studio and gcc don't natively
 * support.  Our work-around is to include <stdbool.h> and then define _Bool
 * back to bool here.
 */
#include <stdbool.h>
#define _Bool bool
...
#define OP_MAX_ERROR_MESSAGE 500
...
void opmock_remove_order_errors(); // snowbird (western digital) extension
